(function(){
    var stage, textStage, form, input,hovertree;
    var circles, textPixels, textFormed;
    var offsetX, offsetY, text;
    var colors = ['#ff0000', '#00ff00', '#FF5F8D', '#37A9CC', '#188EB2'];
    ...
    function init() {
        ...
        animate();
        addListeners();
        hovertree = document.getElementById("hovertree");
    }
    ...
    function addListeners() {
        form.addEventListener('submit', function(e) {
            ...
            if(textFormed) {
                ...
                setTimeout("hovertree.style.display = 'flex'", 1000);
                //if (input.value != '')
                //{
                //    setTimeout(function() {
